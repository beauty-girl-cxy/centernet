  ...
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.colors_hp = [(255, 0, 255), (255, 0, 0), (0, 0, 255), 
        ...
        (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255),
        (255, 0, 0), (0, 0, 255)]
    elif dataset=='mydataset_hp':
      self.names = mydataset_class_name
      self.num_class = 1
      self.num_joints = 5
      self.edges = [[0, 1], [0, 3], [0, 4], 
              [1, 2], [1, 3], [1, 4]]
      self.ec = [(255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255)]
      self.colors_hp = [(255, 0, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255)]
    elif num_classes == 1 or dataset == 'mydataset':
      self.names = mydataset_class_name
